function blk_reactor_BaCl2_NH3_no_walls(blk)

%% Simulink block callback.
% Block name: blk_reactor_BaCl2_NH3_no_walls
...
Pr_0_str = num2str(y.Pr_0);
dh_r_0_str = num2str(y.dh_r_0);
ds_r_0_str = num2str(y.ds_r_0);
%
R_str = num2str(R);
%
...
set_param(blk,'Pr_0',Pr_0_str);
set_param(blk,'dh_r_0',dh_r_0_str);
set_param(blk,'ds_r_0',ds_r_0_str);
